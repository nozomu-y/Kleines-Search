...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <p class="text-muted text-center"><strong>Kleines Search</strong> by 18T Nozomu Yamazaki<br>Hosted on <a href="https://github.com/nozomu-y/Kleines-Search" target="_blank">GitHub</a></p>
        </div>
    </footer>
